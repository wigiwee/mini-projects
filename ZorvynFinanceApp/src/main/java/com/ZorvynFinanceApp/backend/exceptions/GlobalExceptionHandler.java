...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse<String>> handleNoResourceFoundException(
    ...
    public ResponseEntity<ErrorResponse<String>> handleSignatureException(SignatureException exception) {
